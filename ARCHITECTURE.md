...
ConvoShelf הוא יישום שולחן עבודה המבוסס על Tauri 2. ממשק React מציג חוויית שימוש עברית מימין לשמאל, ו־Rust אחראי לחילוץ קובצי ZIP, לפענוח השיחה, לשמירת SQLite ולהגשת המדיה המקומית. תוכן השיחות אינו נשלח ברשת.
...
התקנות קיימות שהשתמשו במזהים הישנים `com.israelfarkash.whatsappexportviewer` או `com.whatsappexportviewer.app` ממשיכות להשתמש אוטומטית בתיקיית הנתונים הישנה, כדי ששדרוג לא ישכפל או יסתיר שיחות שיובאו בעבר.
